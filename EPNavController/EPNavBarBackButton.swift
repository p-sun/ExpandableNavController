...
class EPNavBarBackButton: UIControl {
    ...
    private lazy var backImageView: UIView = {
        ...
        let bundle = Bundle(for: EPNavBarBackButton.self)
        imageView.image = UIImage(named: "EPBack", in: bundle, compatibleWith: nil)
    ...
    private lazy var backTitleLabel: UILabel = {
        let label = UILabel()
        label.attributedText = EPNavController.appearance.backAttributedString("Back")
